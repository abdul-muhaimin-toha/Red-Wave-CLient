...
const DashBoardSideBar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed z-50 flex h-screen w-60 ${isSideBarVisible ? "" : "-translate-x-full"} flex-col space-y-6 border-r-2 bg-background px-3 pt-20 md:translate-x-0 md:pt-8`}
      >
